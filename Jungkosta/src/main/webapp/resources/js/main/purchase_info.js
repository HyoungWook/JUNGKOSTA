$(function() {
	...
	$("#aucPurchase_list").on(
			...
			function() {
				...
				$.ajax({
					url : "/Jungkosta/auction/completeToSale",
					type : "post",
					dataType : "text",
	...
	function getInfo(entry) {
		var info = {
			...
			status : entry.bid_status,
			receive_man : name,
			phoneNum : phoneNum,
			address : entry.del_address,
			st : {
	...
	function getStart() {
		$.getJSON("getAucPurList", function(data) {
...
$(function() {
	...
	$form.submit(function(event) {
		...
		$.ajax({
			url : "/Jungkosta/auction/auctionComment",
			type : "post",
			data : that.serialize(),
			dataType : "text",
