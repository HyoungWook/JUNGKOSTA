		...
		<div id="nav">
			<div class="row">
				<div class="col-md-12">
					...
					<a href="/Jungkosta/auction/auctionList" class="a_nav">경매</a> <a
					...
					<div id="more_nav_ws" class="collapse">
						<div class="row">
							<div class="col-md-5 category_nav_ws">
								<div class="row">
									<div class="col-md-12 title_nav_ws">전자제품</div>
								</div>
								<div class="row">
									<div class="col-md-6">
							...
							<div class="col-md-3 category_nav_ws">
								<div class="row">
									<div class="col-md-12 title_nav_ws">여행/문화</div>
								</div>
								<div class="row">
									<div class="col-md-12">
										<div class="content_nav_ws">
							...
							<div class="col-md-4 category_nav_ws" id="last_category_ws">
								<div class="row">
									<div class="col-md-12 title_nav_ws">해외 명품</div>
								</div>
								<div class="row">
									<div class="col-md-12">
										<div class="content_nav_ws">
